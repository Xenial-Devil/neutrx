...
Neutrx is maintained as an open-source project for secure Node.js backend service-to-service HTTP. This policy explains where users should ask for help, where security reports belong, and how sponsorship supports ongoing maintenance.
...
- Documentation gaps.
- Migration questions.
- Feature requests aligned with secure backend HTTP usage.

Open an issue at:

- https://github.com/Xenial-Devil/neutrx/issues
...
- https://github.com/sponsors/Xenial-Devil
