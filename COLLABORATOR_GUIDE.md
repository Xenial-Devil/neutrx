...
This guide is for Neutrx maintainers and trusted collaborators. Neutrx is source-available under a restrictive license. Collaboration must protect users, project reputation, release integrity, and license boundaries.
...
- Protect security-first behavior and documented defaults.
- Keep public APIs stable unless a breaking change is approved.
- Maintain tests and documentation with code changes.
- Respect maintainer decisions on scope, roadmap, releases, and license permissions.
- Avoid conflicts of interest when reviewing external contributions.
- Escalate security, legal, or publishing questions to the project owner.
...
- Do not approve license, package name, branding, or publishing changes without owner approval.
...
- Passing CI checks.
- No force pushes.
- Linear or otherwise auditable history, based on repository policy.
...
- Restrictive license compliance.
...
- Retry, cache, and interceptor tests for resilience or behavior changes
...
Forks are allowed only for contribution back to the original repository. Publishing, redistributing, selling, rebranding, or releasing modified versions is not allowed without written permission from the project owner.
