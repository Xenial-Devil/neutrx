...
Report conduct issues privately to the project owner or maintainers. Include:

- A short description of what happened.
- Links, screenshots, or message references when available.
- Names or handles of involved parties.
- Whether immediate action is needed.

Do not report security vulnerabilities through conduct channels. Use the private security process in [SECURITY.md](SECURITY.md).

## Enforcement Process

Maintainers may review reports, request more information, consult trusted collaborators, and decide appropriate action. Enforcement may include:

- Private clarification or warning.
- Editing or deleting comments.
- Closing or locking issues and pull requests.
- Rejecting contributions.
- Temporary or permanent removal from project spaces.
- Escalation to hosting or package platform abuse channels when needed.

Maintainers will avoid public disclosure of reporter details unless required for safety, legal compliance, or platform enforcement.
